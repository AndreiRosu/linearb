...
var gitstreamCoreJs = require('@linearb/gitstream-core-js');
...
var fs = require('fs');
var parse = _interopDefault(require('parse-diff'));
var core = require('@actions/core');
var Amplitude = require('@amplitude/node');
var linodeCommon = require('@linearb/linode-common');
...
var RuleParser = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 6:
              ...
              if (!(run.action === gitstreamCoreJs.validatorsConstants.SUPPORTED_ACTIONS.EXPLAIN_CODE_EXPERTS)) {
                _context3.next = 14;
                break;
              }
  ...
  _proto.validateCM = function validateCM() {
    ...
    var validators = (_validators = {}, _validators[Validators.FiltersValidator] = new gitstreamCoreJs.FiltersValidator(), _validators[Validators.ActionsValidator] = new gitstreamCoreJs.ActionsValidator(), _validators[Validators.FileStructureValidator] = new gitstreamCoreJs.FileStructureValidator(), _validators[Validators.SavedWordsValidator] = new gitstreamCoreJs.SavedWordsValidator(), _validators[Validators.ContextVariableValidator] = new gitstreamCoreJs.ContextVariableValidator(), _validators);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            rulesObj = yaml.load(rules.replaceAll(/{{(.*?)}}|{(.*?)}|{%.*%}((.|\n)*){% endfor %}/g, ''));
...
var executeGitCommand = function executeGitCommand(command, folder) {
  ...
  try {
    ...
    var gitResult = child_process.execSync(cdCommand + command, _extends({}, CWD, {
...
var readRemoteFile = function readRemoteFile(file, branch, folder) {
  ...
  try {
    ...
    return fs.readFileSync(SOURCE_CODE_WORKING_DIRECTORY + "/" + folder + "/" + file, 'utf8');
  } catch (_unused) {
    return '';
  }
};
...
var saveResultsInCache = function saveResultsInCache(results) {
  try {
    fs.writeFileSync(SOURCE_CODE_WORKING_DIRECTORY + "/cache.json", JSON.stringify(results));
  } catch (e) {
...
var loadCacheResults = function loadCacheResults() {
  try {
    var cacheResults = fs.readFileSync(SOURCE_CODE_WORKING_DIRECTORY + "/cache.json").toString();
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            segment = new linodeCommon.SegmentClient({
  ...
  var _ref2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(actions, ruleFile, payload) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            supportedActions = Object.values(gitstreamCoreJs.validatorsConstants.SUPPORTED_ACTIONS_BY_PROVIDER[payload.source] || gitstreamCoreJs.validatorsConstants.SUPPORTED_ACTIONS_BY_PROVIDER["default"]);
                  ...
                  while (1) {
                    switch (_context4.prev = _context4.next) {
                      case 0:
                        ...
                        if (gitstreamCoreJs.validatorsConstants.REQUIRED_ARGUMENTS_BY_ACTIONS[action]) {
                          _context4.next = 5;
                          break;
                        }
                      ...
                      case 5:
                        missingArgs = gitstreamCoreJs.validatorsConstants.REQUIRED_ARGUMENTS_BY_ACTIONS[action].all ? !gitstreamCoreJs.validatorsConstants.REQUIRED_ARGUMENTS_BY_ACTIONS[action].args.every(requiredArgsExists) : !gitstreamCoreJs.validatorsConstants / gitstreamCoreJs.validatorsConstants.REQUIRED_ARGUMENTS_BY_ACTIONS[action].args.some(requiredArgsExists);
                        ...
                        _context4.next = 9;
                        return handleValidationErrors("Missing required args for action: `" + action + "`: [" + gitstreamCoreJs.validatorsConstants / gitstreamCoreJs.validatorsConstants.REQUIRED_ARGUMENTS_BY_ACTIONS[action].args.filter(function (arg) {
                    ...
                    switch (_context6.prev = _context6.next) {
                      case 0:
                        ...
                        unsupportedArgs = Object.keys(args || {}).filter(function (arg) {
                          ...
                          return !((_validatorsConstants$ = gitstreamCoreJs.validatorsConstants.SUPPORTED_ARGUMENTS_BY_ACTION[action]) != null && _validatorsConstants$.includes(arg));
                        });
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            _context9.prev = 0;
            new gitstreamCoreJs.SavedWordsValidator().validate({
              yamlFile: rules
            });
            _context9.next = 8;
            break;
...
//# sourceMappingURL=gitstream-core.cjs.development.js.map
