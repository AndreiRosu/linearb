...
function contextifyRequestMiddleware(req, res, next) {
  ...
  var requestId = headerRequestId || queryRequestId || v4();
...
function createLogger(options) {
  ...
  var _transports = [new transports.Console({
    level: consoleLevel,
    handleExceptions: true
  })];
  var logger = createLogger$1({
...
export { FIELDS_TO_OMIT, SafeStringifyReplacer, StringifyReplacer, createLogger, parseURL };
//# sourceMappingURL=linode-logger.esm.js.map
